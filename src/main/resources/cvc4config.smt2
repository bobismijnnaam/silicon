...
; CVC4: Unsupported (set-option :global-decls true) ; Boogie: default
; CVC4: Unsupported (set-option :auto_config false) ; Usually a good idea

; CVC4: Unsupported (set-option :smt.restart_strategy 0)
